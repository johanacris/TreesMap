...
<%
    ...
    String cultivo = (String)request.getSession().getAttribute("cultivo");
    request.getSession().setAttribute("user", user);
    request.getSession().setAttribute("cultivo", cultivo);
%>
...
<html>
    <head>
        ...
        <!--my css-->
        <link href="css/estilo_registro_veneno.css" rel="stylesheet" type="text/css"/>
        <!--my javascirpt-->
    ...
    <body>
        ...
        <div class="contedio" >
            ...
            <div class="card">
                <h2 style="font-weight: bolder;">Ingrese los datos del Veneno</h2>
                <form  id='form-registrar-veneno' action='leer_formulario_crear_veneno.do' method='POST'>
                <input type='text' name='nombre-veneno' placeholder='Nombre del Veneno' required/>
                <input type='text' name='tipo-veneno' placeholder='Tpo del Veneno' required/>
                <input type='date' name='fecha-veneno' placeholder='Fecha de Veneno' required/>
                <textarea name='anotacion' rows='4' cols='50' placeholder='Notas'></textarea>
