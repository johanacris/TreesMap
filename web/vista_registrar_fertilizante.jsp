...
<html>
    <head>
        ...
        <!--my css-->
        <link href="css/estilo_registro_fertilizante.css" rel="stylesheet" type="text/css"/>
        <!--my javascirpt-->
    ...
    <body>
        ...
        <div class="contedio" >
            ...
            <div class="card">
                <h2 style="font-weight: bolder;">Ingrese los datos del Fertilizante</h2>
                <form  id='form-registrar-fertilizante' action='leer_formulario_crear_fertilizante.do' method='POST'>
                <input type='text' name='nombre-fertilizante' placeholder='Nombre del Fertilizante' required/>
                <input type='text' name='tipo-fertilizante' placeholder='Tpo del Fertilizante' required/>
