...
<html>
    <head>
        ...
        <!--my css-->
        <link href="css/estilo_registro_plaga.css" rel="stylesheet" type="text/css"/>
        <!--my javascirpt-->
    ...
    <body>
        ...
        <div class="contedio" >
            ...
            <div class="card">
                <h2 style="font-weight: bolder;">Ingrese los datos del Plaga</h2>
                <form  id='form-registrar-plaga' action='leer_formulario_crear_plaga.do' method='POST'>
                <input type='text' name='nombre-plaga' placeholder='Nombre del Plaga' required/>
                <input type='text' name='tipo-plaga' placeholder='Tpo del Plaga' required/>
                <input type='date' name='fecha-plaga' placeholder='Fecha de Plaga' required/>
