 ...
 * @author Romario
 */
public class Leer_Formulario_Editar_Cultivo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Cultivo cultivoActualizado = new Cultivo(nombre, fecha, latitud, longitud, especie, genero, familia, orden, clase, division, usuario);
        if(n.actualizarCultivo(cultivoActualizado, cultivoId)){
